...
export const dataStoreSlice = createSlice({
  ...
  reducers: {
    ...
    updateProject: (state,action) =>{
      state.myproject[action.payload.index][action.payload.key] = action.payload.value
    },
...
export const { updatePersonalInfo, updateWorkEx,updateEducation,updateKeySkills,
  updateErrorMessages, updateState,addArrayElement,removeArrayElement,updateProject } = dataStoreSlice.actions
